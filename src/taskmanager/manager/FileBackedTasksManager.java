...
public class FileBackedTasksManager extends InMemoryTaskManager {
    private static final Path backedTasks = Paths.get("src/taskmanager/manager", "Backed_tasks.csv");
    ...
    private Task taskFromString(String value) {
        Task task = new Task("Default", "Default");
        Epic epic = new Epic("Default", "Default");
        SubTask subTask = new SubTask("Default", "Default", 0);
        String[] line = value.split(",");
        switch (line[1]) {
            case "TASK" -> {
